    ...
    init() {
      ...
      this._inspectorStateHandler = (e) => {
        if (this._inspectorFloatButton) {
          this._inspectorFloatButton.classList.toggle(
            "mageforge-active",
            e.detail.active,
          );
          this._inspectorFloatButton.setAttribute(
            "aria-pressed",
      ...
      window.addEventListener(
        "mageforge:toolbar:inspector-state",
        this._inspectorStateHandler,
      );
...
if (typeof Alpine !== "undefined") {
  ...
  document
    .querySelectorAll('[x-data="mageforgeInspector"]')
    .forEach(function (el) {
