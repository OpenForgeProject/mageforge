...
export const uiMethods = {
  ...
  createHighlightBox() {
    ...
    this.highlightBox.className =
      "mageforge-inspector mageforge-inspector-highlight";

    // Propagate theme from root element to injected body element
    if (this.$el && this.$el.hasAttribute("data-theme")) {
      this.highlightBox.setAttribute(
        "data-theme",
  ...
  createInfoBadge() {
    ...
    this.infoBadge.className =
      "mageforge-inspector mageforge-inspector-info-badge";

    // Propagate theme from root element to injected body element
    if (this.$el && this.$el.hasAttribute("data-theme")) {
      this.infoBadge.setAttribute(
        "data-theme",
        this.$el.getAttribute("data-theme"),
      );
    }
  ...
  updateFloatingButton() {
    window.dispatchEvent(
      new CustomEvent("mageforge:toolbar:inspector-state", {
  ...
  createBrandingFooter() {
    ...
    madeWithDiv.innerHTML =
      'Made with <span style="color: #ff6b6b; font-size: 12px;">🧡</span> by <span style="color: #60a5fa; font-weight: 600;">MageForge</span>';
    ...
    featureLink.href =
      "https://github.com/OpenForgeProject/mageforge/issues/new?template=feature_request.md";
    featureLink.target = "_blank";
    featureLink.rel = "noopener noreferrer";
    featureLink.innerHTML =
      'You miss a <span style="text-decoration: underline;">Feature?</span>';
