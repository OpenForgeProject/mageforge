...
export const accessibilityMethods = {
  ...
  renderAccessibilityTab(container, element) {
    ...
    container.appendChild(
      this.createInfoSection("Element Type", a11yData.tagName, "#60a5fa"),
    );

    // ARIA Role
    if (a11yData.role) {
      container.appendChild(
        this.createInfoSection("ARIA Role", a11yData.role, "#a78bfa"),
      );
    }
    ...
    if (a11yData.ariaLabel) {
      container.appendChild(
        this.createInfoSection("ARIA Label", a11yData.ariaLabel, "#22d3ee"),
      );
    }
    ...
    if (a11yData.altText !== null) {
      ...
      container.appendChild(
        this.createInfoSection("Alt Text", altStatus, altColor),
      );
    }
    ...
    if (a11yData.lazyLoading !== null) {
      ...
      container.appendChild(
        this.createInfoSection("Lazy Loading", a11yData.lazyLoading, lazyColor),
      );
    }
    ...
    if (a11yData.tabindex !== null) {
      container.appendChild(
        this.createInfoSection("Tab Index", a11yData.tabindex, "#fb923c"),
      );
    }
    ...
    container.appendChild(
      this.createInfoSection("Focusable", focusableText, focusableColor),
    );

    // ARIA Hidden
    if (a11yData.ariaHidden) {
      container.appendChild(
        this.createInfoSection("ARIA Hidden", a11yData.ariaHidden, "#ef4444"),
      );
    }
    ...
    container.appendChild(
      this.createInfoSection("Interactive", interactiveText, interactiveColor),
    );
  },
  ...
  analyzeAccessibility(element) {
    ...
    const role =
      element.getAttribute("role") || this.getImplicitRole(tagName, element);
  ...
  checkLazyLoading(element, tagName) {
    ...
    const hasDataSrc =
      element.hasAttribute("data-src") || element.hasAttribute("data-lazy");
